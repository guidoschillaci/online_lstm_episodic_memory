...
if __name__ == "__main__":
    main_path = '../../results/'
    directory = main_path + 'exp_6_iter_0' + '/'
    ...
    #learning_progress = np.load(directory + 'learning_progress.npy')
    ...
    plt.ylim(0, 0.5)
    plt.title('Mean Squared Error - MemStrategy: ')# + str(parameters['memory_update_strategy']) )
